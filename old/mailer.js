...
async function sendVerificationEmail(email, username, token) {
    ...
    try {
        ...
        console.log(`✉️ [MAILER] Verification successfully sent to ${email}. MessageId: ${response.data.messageId}`);
        return { success: true };
    } catch (error) {
        console.error('❌ [MAILER ERROR] Transactional relay dropped execution:', error.response ? error.response.data : error.message);
