...
function cleanReleaseName(folderName) {
    ...
    title = title.replace(/^www\.[a-zA-Z0-9-]+\.(?:org|net|com|cc|tv|me)\s*-\s*/i, '');
    title = title.replace(/^[a-zA-Z0-9-]+\.(?:org|net|com|cc|tv|me)\s*-\s*/i, '');

    const junkPatterns = [
        /[._-]v\d+/i, /[._-]v[eE]r\d+/i, /\b(?:720p|1080p|2160p|4k)\b/i,
        /\b(?:HDTS|CAM|TS|TC|HDRip|WEBRip|BluRay|BRRip)\b/i,
        /\b(?:x264|x265|h264|hevc|AVC|AAC|MP3|DDP5\.1)\b/i,
        /\bMeGusta\b/i,
        /\bingest\b/i,
