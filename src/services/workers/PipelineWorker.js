...
async function checkPipelineCompletions() {
    ...
    try {
        ...
        try {
            ...
            await axios.post(`${QBIT_URL}/api/v2/torrents/removeTags`, `hashes=${torrentHash}&tags=${activeTag}`, {
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
            });
            
            await axios.post(`${QBIT_URL}/api/v2/torrents/addTags`, `hashes=${torrentHash}&tags=${processedTag}`, {
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
            });
